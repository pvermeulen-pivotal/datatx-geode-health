package util.geode.health.impl;
...
import util.geode.health.HealthCheck;
...
public class HealthCheckImpl implements HealthCheck {
	...
	private boolean getSendAlertPropertyFile() {
		...
		try {
			InputStream input = HealthCheckImpl.class.getClassLoader().getResourceAsStream(ALERT_PROPS);
